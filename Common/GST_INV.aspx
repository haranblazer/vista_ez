<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GST_INV.aspx.cs" Inherits="Common_GST_INV" %>
       ...
       <%-- <div class="right-sign">
        ...
        <header class="clearfix">
            ...
            <div id="project">
                ...
                <div><span class="total-bold">User Id: </span>
                ...
                <div>
                    <asp:Label ID="lbl_ComAdd" runat="server" Width="100%"></asp:Label></div>
                <div><span class="total-bold">Tel : </span>
                    <asp:Label ID="lbl_ComMobileno" runat="server"></asp:Label></div>
                <div><span class="total-bold">Email:</span>
                    <asp:Label ID="lbl_ComEmail" runat="server"></asp:Label>
                </div>
                
                <div><span class="total-bold">GSTIN :</span>
                    <asp:Label ID="lbl_ComGSTIN" runat="server"></asp:Label>
                </div>
                <div><span class="total-bold">PAN :</span>
                    <asp:Label ID="lbl_ComPanNo" runat="server"></asp:Label>
                </div>
                <div><span class="total-bold">CIN :</span>
                    <asp:Label ID="lbl_ComCIN" runat="server"></asp:Label>
                </div>
                 <hr />
                <div><span class="total-bold">Invoice No. :</span>
                    <asp:Label ID="lbl_UserINVNo" runat="server"></asp:Label>
                </div>
                <div><span class="total-bold">Invoice Type :</span>
                    <asp:Label ID="lbl_UserInvType" runat="server" Style="width: 55%;"></asp:Label>
                </div>

                <div><span class="total-bold">Invoice Date :</span>
                    <asp:Label ID="lbl_UserINVDate" runat="server"></asp:Label>
                </div>
                <div style="display:none;"><span class="total-bold">PO No. :</span>
                    <asp:Label ID="lbl_User_PO_NO" runat="server"></asp:Label>
                </div>
                <div><span class="total-bold">E-Way Bill No. : </span>
                    <asp:Label ID="lbl_EwayNo" runat="server"></asp:Label>
                </div>
                <div><span class="total-bold">Pay Mode :</span>
                    <asp:Label ID="lbl_PayMode" runat="server"></asp:Label>
                </div>

                <div style="display: none;"><span>E-Way Bill No. : </span>NA    </div>

                <div style="display: none;"><span>Invoice No. :</span>
                    <asp:Label ID="lbl_InvoiceNo" runat="server"></asp:Label>
                </div>
                <div style="display: none;"><span>Invoice Type :</span>
                    <asp:Label ID="lbl_InvType" runat="server"></asp:Label>
                </div>
                <div style="display: none;"><span>Invoice Date :</span>
                    <asp:Label ID="lbl_InvoiceDate" runat="server"></asp:Label>
                </div>
                <div style="display: none;"><span>Date PO No. :</span>
            ...
            <div id="company" class="clearfix">
                ...
                <div class="total-bold">
                    <asp:Label ID="lbl_UserName" runat="server"></asp:Label></div>
                <div>
                ...
                <div><span class="total-bold">CIN :</span>
                 ...
                 <hr />
                <div><span class="total-bold">Shipping Address : </span>
                    <asp:Label ID="lbl_ShipingAdd" runat="server"></asp:Label>
                </div>

                 <div><span class="total-bold">Transport Name: </span>
                    <asp:Label ID="lbl_TransportName" runat="server"></asp:Label></div>

                 <div><span class="total-bold">Bility No.: </span>
                    <asp:Label ID="lbl_BilityNo" runat="server"></asp:Label></div>
                ...
                <table>
                    <tbody>
                        <tr style="background: #ddd">
                            ...
                            <th class="desc total-bold">Income Type</th>
                            <th class="total-bold">Month</th>
                            <th class="total-bold">HSN Code </th>
                            <th class="total-bold">Billing Amount</th>
            ...
            <FooterTemplate>
                <tr>
                    ...
                    <td class="total-bold" style="text-align: right;">
                        <asp:Label ID="lblGrossAmt" runat="server"></asp:Label>
                    </td>
                    <td class="total-bold" style="text-align: right;">0
                    </td>
                    <td class="total-bold" style="text-align: right;">
                        <asp:Label ID="lblTaxRs" runat="server"></asp:Label>
                    </td>
                    <td class="total-bold" style="text-align: right;">
