<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserPOBill.aspx.cs" Inherits="Common_UserPOBill" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        ...
        <header class="clearfix">
            ...
            <div id="project">
               <div class="total-bold"><span>CIN:</span><%=method.COMP_CINNO%>
                ...
                <div>
                    ...
                    <asp:Label ID="lbl_UserINVNo" Width="52%" runat="server"></asp:Label>
                </div>
                <%-- <div><span>Invoice Type :</span> <asp:Label id="lbl_UserInvType" runat="server"></asp:Label> </div>--%>
                <div>
            ...
            <div id="company" class="clearfix">
                ...
                <div>
                    <asp:Label ID="lbl_ShipingAdd" runat="server"></asp:Label></div>
            </div>
        </header>
        <asp:Repeater ID="Repeater" runat="server">
                    ...
                    <tbody>
                        <tr style="background: #ddd;">
                          ...
                          <%--  <th class="total-bold">Tax</th>--%>
                            <th class="total-bold"><%=method.DP%>(incl.Tax)</th>
                            <th class="total-bold">
            ...
            <FooterTemplate>
                <tr>
                    ...
                    <td class="total-bold" style="text-align: right;">
                        <asp:Label ID="lbl_Gross_Total" runat="server"></asp:Label>
                    </td>
                     <td class="total-bold" style="text-align: right;">0
                    </td>
                    <td class="total-bold" style="text-align: right;">
                        <asp:Label ID="lbl_Disc_Total" runat="server"></asp:Label>
                    </td>
        ...
        <table style="width: 30%; margin-left: 2%; float: right">
            ...
            <tr>
                <td class="total-bold" style="border-bottom: none;">Invoice Value(Rs) :</td>
                <td class="grand total" style="border-bottom: none; text-align: right;">
                    <asp:Label ID="lbl_NetTotal" runat="server">0</asp:Label>
                </td>
            </tr>
            <tr>
                <td class="total-bold" style="border-bottom: none;">Gross Weight :</td>
                <td class="total-bold" style="border-bottom: none; text-align: right;">
                    <asp:Label ID="lbl_GrossWeight" runat="server">0</asp:Label>
                </td>
            </tr>
            <tr>
                <td style="border-bottom: none;" class="total-bold"><%=method.REPURCHASE_PV%> :</td>
                <td class="total" style="border-bottom: none; text-align: right;">
                    <asp:Label ID="lbl_PV" runat="server">0</asp:Label>
                </td>
            </tr>
        </table>
        <div class="clearfix"></div>
