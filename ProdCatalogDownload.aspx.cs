...
public partial class ProdCatalogDownload : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        DataTable dt = objDu.GetDataTable("Select Title, FileName from DownloadMst where status=1 and DocType=1 and  DisplayType='All'");
