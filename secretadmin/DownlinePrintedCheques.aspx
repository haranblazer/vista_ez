<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DownlinePrintedCheques.aspx.cs" Inherits="DownlinePrintedCheques" %>
           ...
           <tr>
               <td style="width: 98px; text-align: left">
                   <table style="width: 657px">
                       <tr>
                           <td colspan="1" style="width: 208px; text-align: left">
                               <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial" Text="Registration Number"
                                   Width="207px"></asp:Label></td>
                           <td colspan="2" style="text-align: left">
                               <span style="font-size: 10pt; font-family: Arial">&nbsp;<asp:Label ID="LblRegNo"
                                   runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small" ForeColor="#C00000"></asp:Label></span></td>
                       </tr>
                       <tr>
                           <td colspan="1" style="width: 208px; text-align: left">
                               <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Medium"
                                   Text="Payout Number"></asp:Label></td>
                           <td colspan="2" style="text-align: left">
                               <asp:Label ID="LblPayOutNo" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small"
