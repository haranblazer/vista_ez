                    ...
                    <table style="width: 100%; text-align: left;" class="withclass">
                        ...
                        <tr id="tblBillHeader">
                            ...
                            <td style="text-align: left; vertical-align: top; width: 50%;">
                                ...
                                <asp:TextBox ID="txtDAddress" TextMode="MultiLine" runat="server" Height="50px" 
                            ...
                            <td style="text-align: center;">
                                ...
                                <asp:GridView ID="GridView1" CssClass="printmygrd" Style="width: 100%;" DataKeyNames="id"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="VAT/CST(%)" ControlStyle-Width="50" ItemStyle-HorizontalAlign="Right"
                                            FooterStyle-CssClass="footerstylebodder" HeaderStyle-HorizontalAlign="Right"
                                            FooterStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Tax" ControlStyle-CssClass="hide_class " FooterStyle-CssClass="hide_class"
                        ...
                        <tr>
                            <td>
                                <div class="totalnet">
                                    ...
                                    <asp:Button ID="btnGenerateBill" runat="server" OnClick="btnGenerateBill_Click" Text="Generate Bill"
                                        ValidationGroup="g" />
                                    <br />
