<%@ Page Title="" Language="C#" MasterPageFile="~/secretadmin/MasterPage.master"
    AutoEventWireup="true" CodeFile="AssociateRepurchaseBill.aspx.cs" Inherits="secretadmin_AssociateRepurchaseBill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h2 class="head">
        <i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;Associate Repurchase Bill</h2>
        <br />
    <div>
        ...
        <div class="col-sm-2" style="margin-bottom: 15px;">
            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control">
                <asp:ListItem Value="3" Selected="True">Repurchase </asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="col-sm-1">
    ...
    <div class="table-responsive">
        <asp:GridView AllowPaging="true" ID="GridView1" runat="server" CssClass="table table-striped table-hover mygrd"
            ...
            Width="100%" OnPageIndexChanging="GridView1_PageIndexChanging" EmptyDataText="No Data Found"
            EmptyDataRowStyle-ForeColor="Red" OnRowCancelingEdit="GridView1_RowCancelingEdit"
