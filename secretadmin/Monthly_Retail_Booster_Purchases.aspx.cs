...
public partial class secretadmin_Monthly_Retail_Booster_Purchases : System.Web.UI.Page
{
    ...
    public void dataReports()
    {
        ...
        try
        {
            ...
            DataTable dt = objDUT.GetDataTableSP(sqlparam, "GetRetail_Booster_PIVOT");
            int i;
            for (i = 0; i <= 18; i++)
            {
                grandtotal[i] = 0;
