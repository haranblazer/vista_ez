<%@ Page Language="C#" AutoEventWireup="true" CodeFile="moneybackamount.aspx.cs" Inherits="admin_moneybackamount" %>
   ...
   <table border="0" cellpadding="0" cellspacing="0" style="width: 800px">
        ...
        <tr>
            ...
            <td style="border-right: #000000 1px solid; border-top: #000000 1px solid; border-left: #000000 1px solid;
                ...
                text-align: center">
                <strong><span style="font-size: 16px; color: #ffffff">Details Cause for Money back Income</span></strong></td>
            <td style="width: 50px; height: 25px">
            </td>
        </tr>
        <tr>
            ...
            <td style="border-right: #000000 1px solid; border-top: #000000 1px solid; border-left: #000000 1px solid;
                ...
                <asp:GridView ID="GridView1"  runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Amount" HeaderText="Money back Income" />                     
