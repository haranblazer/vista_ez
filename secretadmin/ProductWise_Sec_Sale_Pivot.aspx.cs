...
//using System.Linq;
//using System.Web;
public partial class secretadmin_ProductWise_Sec_Sale_Pivot : System.Web.UI.Page
{
    ...
    public void dataReports()
    {
        ...
        try
        {
            ...
            DataTable dt = objDUT.GetDataTableSP(sqlparam, "GetSecondarySaleProductWise_PIVOT");
            int i;
            for (i = 0; i <= 17; i++)
            {
                grandtotal[i] = 0;
        ...
        //con.Open();
        //SqlCommand cmd = new SqlCommand("GetSecondarySaleProductWise_PIVOT", con);
    ...
    protected void grdProductprimary_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //salesvalue = (total * Convert.ToDecimal(e.Row.Cells[3].Text));
    ...
    private void ExportFile()
    {
        ...
        string fileName = "ProductWiseSecondarySales_" + DateTime.Now.ToShortDateString() + ".xls",
        contentType = "application/vnd.ms-excel";
        ...
        Response.Buffer = true;
        Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", fileName));
        Response.Write("<Table><tr><td></td><td></td><td></td><td></td><td style=font-size:20px><b>Product Wise Secondary Sales</b></td><td></td></tr></Table>");
        Response.ContentType = contentType;
    ...
    protected void imgbtnCsv_Click(object sender, EventArgs e)
    {
        if (grdProductprimary.Rows.Count > 0)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=ProductWiseSecondarySales_" + DateTime.Now.ToShortDateString() + ".csv");
            Response.Charset = "";
