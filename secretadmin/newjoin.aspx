...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h4 class="fs-20 font-w600  me-auto">Associates Registration</h4>
    </div>
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-md-6">
                                <asp:TextBox ID="txt_Userid" runat="server" CssClass="form-control" placeholder="Enter Your Userid" MaxLength="30"></asp:TextBox>
                            </div>
                    ...
                    <div class="clearfix"></div>
                            ...
                            <div class="col-md-1 col-xs-4" style="padding-right: 0px;">
                            ...
                            <div class="col-md-5 col-xs-8">
                                <asp:TextBox ID="txtGName" runat="server" MaxLength="50" CssClass="form-control"
                                    placeholder="Enter Your Guardian's Name"></asp:TextBox>
                            </div>
                     ...
                     <div class="clearfix"></div>
                            ...
                            <div class="col-md-6">
                                <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" placeholder="Address" Height="60px" Width="100%"
                                    CssClass="form-control" MaxLength="400"></asp:TextBox>
                            </div>
                       
                           
                            <div class="col-md-6">
                                <asp:TextBox ID="txtCity" runat="server" CssClass="form-control" MaxLength="50" placeholder="City"></asp:TextBox>
                            </div>
                     ...
                     <div class="clearfix"></div>
                            ...
                            <div class="col-md-6">
                                <asp:TextBox ID="txt_Pincode" runat="server" CssClass="form-control" MaxLength="6" placeholder="Pin Code"></asp:TextBox>
                            </div>
                    ...
                    <div class="clearfix"></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="txt">Please accept <a class="txt" href="../terms-and-condition.aspx" target="_blank"
                                    style="color: #551e00; text-align: justify;">Terms &amp; Conditions </a></span>
                                <div class="clearfix">
                                </div>
                                <br />
                                <input type="button" id="btn_submit" value="Submit" onclick="Validation();" class="btn btn-primary" />
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12 d-none" style="height: 150px; overflow-x: auto;">
                            <h5>Terms & Conditions
                            </h5>
                            <p>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%=txt_SponsorId.ClientID %>').keypress(function (e) {
             ...
             $('#<%=txt_Userid.ClientID %>').keypress(function (e) {
                if (e.which != 8 && e.which != 0 && (e.which < 65 || e.which > 90) && (e.which < 90 || e.which > 122) && (e.which < 48 || e.which > 57)) { return false; }
                if (e.which == 91 || e.which == 93 || e.which == 94 || e.which == 95 || e.which == 96) { return false; }
            });
        ...
        function Validation() {
            ...
            var Userid = $('#<%=txt_Userid.ClientID%>').val(),
                SponsorId=$('#<%=txt_SponsorId.ClientID%>').val(),
            ...
            $.ajax({
                ...
                data: '{Userid: "' + Userid + '", SponsorId: "' + SponsorId + '", Position: "' + Position + '",  Title: "' + Title + '", Name: "' + Name + '", state: "' + state + '", Gtitle: "' + Gtitle
                ...
                success: function (data) {
                    if (data.d.Error == "") {
                        ...
                        alert("Your Details Save Successfully. Userid is: " + data.d.Regno);
