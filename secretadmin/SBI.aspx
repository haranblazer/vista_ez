<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SBI.aspx.cs" Inherits="admin_SBI" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>SBI Cheque</title>
     <style type="text/css">
...
<body style="margin-left: 10px; margin-right: 10px;margin-top:20px" >
 ...
 <center> <div style="padding-left:45px">  <asp:Repeater ID="Repeater1" runat="server">
      ...
      <ItemTemplate><asp:Panel ID="Panel1" runat="server" Height="650px" Width="567px">
  ...
  <table border="0" width="300px" cellpadding="0" cellspacing="0" style="border-top-width: 1px; border-left-width: 1px; border-left-color: black; border-bottom-width: 1px; border-bottom-color: black; border-top-color: black; border-right-width: 1px; border-right-color: black;">
            <tr>
                <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #000000;
                    border-bottom-width: 1px; border-bottom-color: #000000; width: 177px; border-top-color: #000000;
                ...
                <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #000000;
                    border-bottom-width: 1px; border-bottom-color: #000000; width:37px; border-top-color: #000000; border-right-width: 1px; border-right-color: #000000; vertical-align: top; text-align: right;padding-left:5px" rowspan="2">
                ...
                <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #000000;
                    border-bottom-width: 1px; border-bottom-color: #000000; width:232px; border-top-color: #000000; border-right-width: 1px; border-right-color: #000000;padding-right:40px;text-align: left;" rowspan="2" valign="top">
                    <asp:Label ID="Label2" style="writing-mode:tb-rl ;text-align: left;padding-top:60px; margin-left: 15px;" Font-Bold="True" runat="server" Font-Names="Arial" Font-Size="14px"  Text='<%# DataBinder.Eval (Container.DataItem, "name") %>'  Height="450px" Width="33px"></asp:Label></td>
            </tr>
            <tr>
                <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #000000;
                    border-bottom-width: 1px; border-bottom-color: #000000; width: 177px; border-top-color: #000000;
            ...
            <tr>
                ...
                <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #000000;
                    border-bottom-width: 1px; border-bottom-color: #000000; width: 232px; border-top-color: #000000;
                    height: 253px; border-right-width: 1px; border-right-color: #000000; vertical-align: text-top; padding-left: 7px; padding-top: 20px; text-align: center;">
                    <asp:Label ID="Label5" style="writing-mode:tb-rl; margin-top: 15px; margin-right: 10px;" runat="server" Font-Names="Arial" Font-Size="14px" Font-Bold="True"  Text='<%# DataBinder.Eval (Container.DataItem, "paymenttodate") %>'></asp:Label></td>
            </tr>            
