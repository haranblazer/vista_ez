...
<head runat="server">
   <title>Invoice</title>
    <style>
        ...
        {
            color: white;
            text-shadow: #ececec 0.1em 0.7em 0.2em;
            font-size: 20px;
            text-align: center;
            letter-spacing: 2px;
            font-weight: bold;
                                                ...
                                                <table style="border: 2px solid #ddd; width: 97%; margin-left: 16px">
                                                    <tr>
                                                        <td style="border-right: 2px solid #ddd">
                                                            <asp:Image ID="imgLogo" runat="server" Width="233px" Height="120px" />
                                                        </td>
                                                        <td style="padding-top: 5px; width: 250px;">
                                                           <asp:Label ID="lblCNameNew" runat="server" Font-Names="Arial" Font-Size="13pt" Font-Bold="true"></asp:Label> <br />
                                                            <asp:Label ID="lblCAddress" runat="server" Font-Names="Arial" Font-Size="9pt"></asp:Label><br />

                                                            <span style="font-size: 9pt; font-family: Arial">PHONE :   </span><asp:Label ID="lblphoneno" runat="server" Text="Label" style="font-size: 9pt; font-family: Arial"></asp:Label>
                                                            <br />
                                                            <span style="font-size: 9pt; font-family: Arial">WEBSITE   :   </span><asp:Label ID="lblwebsite" runat="server" Text="Label" style="font-size: 9pt; font-family: Arial"></asp:Label>
                                                ...
                                                <table cellspacing="0" style="border: 2px solid #dddddd; width: 99.5%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 300px;">
                                                            <asp:Label ID="lblID" runat="server" Font-Names="Arial" Font-Size="9pt" Font-Bold="True"  ></asp:Label>
                                                        </td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <asp:Label ID="lblClientName" runat="server" Font-Names="Arial" Font-Size="9pt"  Font-Bold="True">Client Name</asp:Label>
                                                        </td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblMobile" runat="server" Font-Names="Arial" Font-Size="9pt"  Font-Bold="True"></asp:Label>
                                                        </td>
                                                        <td><strong><span style="font-size: 10pt; font-family: Arial">INVOICE NO</span></strong> <strong>:</strong>
                                                            <asp:Label ID="lblInvoiceNo" runat="server" Font-Bold="False" Font-Size="10pt" Font-Names="Arial">lblInvoiceNo.</asp:Label>
                                                        </td>
                                                        <td></td>
                                                        <td><strong><span style="font-size: 10pt; font-family: Arial">DATE</span></strong> <strong>:</strong>
                                                            <asp:Label ID="lblInvoicedate" runat="server" Font-Size="10pt" Font-Names="Arial"  Font-Bold="True">Invoicedate.</asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblAdress" runat="server" Width="240px" Font-Size="9pt" Font-Names="Arial"  Font-Bold="True">Address</asp:Label><br />
                                                            <asp:Label ID="lblCity" runat="server" Font-Size="9pt" Font-Names="Arial"  Font-Bold="True">City</asp:Label>
                                                            <asp:Label ID="lblState" runat="server" Font-Size="9pt" Font-Names="Arial"  Font-Bold="True">State</asp:Label>
                                                            <asp:Label ID="lblpincode" runat="server" Font-Size="9pt" Font-Names="Arial"  Font-Bold="True">Pin Code</asp:Label>
                                                        </td>
                                                        <td>
                                                        </td>
                                                        <td></td>
     ...
     <%#Container.ItemIndex+1 %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 100px; border-right: #dddddd 1px solid; border-top: #dddddd 1px solid; border-left: #dddddd 1px solid; border-bottom: #dddddd 1px solid; padding-right: 20px; text-align: right;">
                                                            ...
                                                            <asp:Label ID="Label5" runat="server" Text="Label" Font-Bold="True" Font-Names="Arial" 
                                    ...
                                    <table cellspacing="0" style="width: 97.5%; border: 1px solid #ddd; margin-left: 14px">
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Label ID="lblcnm" runat="server" Font-Bold="true" Font-Names="Arial" Font-Size="10pt"></asp:Label>
                                            </td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Label ID="lblCPanNo" runat="server" Font-Bold="true" Font-Names="Arial" Font-Size="10pt"></asp:Label>
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
