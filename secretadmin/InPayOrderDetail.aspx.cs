...
public partial class franchise_InPayOrderDetail : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        try
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("toordrpaydetails", con);
            ...
            ad.SelectCommand.Parameters.AddWithValue("@userid","-111");
            dt = new DataTable();
            ad.Fill(dt);
    ...
    protected void imgbtnExcel_Click(object sender, ImageClickEventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_View_incoming_PO.xls");
    ...
    protected void imgbtnWord_Click(object sender, ImageClickEventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            GridView1.Columns[16].Visible = GridView1.Columns[17].Visible = false;
            Response.ClearContent();
            Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_View_incoming_PO.doc");
