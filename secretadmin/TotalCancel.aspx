<%@ Page Title="" Language="C#" MasterPageFile="~/secretadmin/MasterPage.master" AutoEventWireup="true" CodeFile="TotalCancel.aspx.cs" Inherits="secretadmin_TotalCancel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <h4 class="head" style="color: #fff;">
                        <i class="fa fa-image-o"></i>&nbsp;Total Cancel
                    </h4>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Sellby">
                   ...
                   <asp:TemplateField HeaderText="Quantity">
                    <ItemTemplate>
                           <asp:LinkButton ID="lblCancelBill" CommandName="CancelBill" OnClientClick="SetTarget();" CommandArgument='<%#((GridViewRow)Container).RowIndex %>'
