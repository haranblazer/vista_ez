<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Monthly_Retail_Booster_Purchases.aspx.cs" Inherits="secretadmin_Monthly_Retail_Booster_Purchases" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

      <h4 class="fs-20 font-w600  me-auto float-left mb-0">Monthly Retail Booster Purchases</h4>
    ...
    <%-- <div class="container-fluid">
            <div class="card-header py-3 align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">
                    <center>Monthly Loyalty Purchases</center>
                </h6>
            </div>
           <br />
            <div class="row">
            ...
            <asp:GridView ID="grdviewdata" runat="server" ShowFooter="true" OnRowDataBound="grdviewdata_RowDataBound">
                <Columns>
