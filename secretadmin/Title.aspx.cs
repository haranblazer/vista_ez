...
public partial class secretadmin_Title : System.Web.UI.Page
{
    ...
    public void BindTitleList()
    {
        try
        {
            ...
            ddlTitleList.Items.Insert(0, new ListItem("All", "0"));
        }
        catch
        {
    ...
    public void BindSearchReward()
    {
        try
        {
            ...
            if (fromDate <= toDate)
            {
                ...
                com.Parameters.AddWithValue("@Regno", txtUser.Text.Trim());
    ...
    protected void btSearchDatewise_Click(object sender, EventArgs e)
    {
        BindDataDatewise();
    }
}