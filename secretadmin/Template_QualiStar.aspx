<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Template_QualiStar.aspx.cs" Inherits="secretadmin_Template_QualiStar" %>
                                    ...
                                    <td style="color: Black; background-color: White;">
                                        <div class="article">
                                            <div style="background-image: url(images/<%=BackGroundImg%>); background-repeat: no-repeat; height: 1280px; width: 720px;">
                                                ...
                                                <div style="padding-left: 0px; padding-top: 55px;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">
                                                                    <div style="font-size: 39px; color: #161511;">
                                                ...
                                                <div style="padding-left: 49px; padding-top: 39px;">
                                                    <table>
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <span style="font-size: 35px; color: #151412; font-weight: 600; font-family: arial;">Name </span>
                                                                </td>
                                                                <td>
                                                                    <span style="font-size: 35px; color: #151412; font-weight: 600; font-family: arial;">: </span>

                                                                </td>
                                                                <td>
                                                                    <span style="font-size: 35px; color: #151412; font-weight: 600; font-family: arial;"><%=UserName%> </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <span style="font-size: 35px; color: #151412; font-weight: 600; font-family: arial;"><%=Distinct%>  </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
