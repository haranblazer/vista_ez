...
using System.Xml;
public partial class secretadmin_AssociateRepurchaseBill : System.Web.UI.Page
{
    DataTable dt = null;
    ...
    private void BindGrid()
    {
        try
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("AssociateBill", con);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("cancel"))
        {
            ...
            try
            {
                    ...
                    //  SqlCommand cmd = new SqlCommand("franchisecancelproduct", con);
                    ...
                    if (status2 == "1")
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "alert('Bill cancel Successfully.');window.location='AssociateRepurchaseBill.aspx';", true);
                    ...
                    else
                    {
                        ...
                        utility.MessageBox(this, status2.ToString());
