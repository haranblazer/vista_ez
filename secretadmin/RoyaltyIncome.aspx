<%@ Page Title="" Language="C#" MasterPageFile="~/secretadmin/MasterPage.master"
    AutoEventWireup="true" CodeFile="RoyaltyIncome.aspx.cs" Inherits="secretadmin_RoyaltyIncome" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding: 15px 0px 0px 15px;">
        <h2 class="head">
            <i class="fa fa-money" aria-hidden="true"></i>&nbsp; Create Royalty Income</h2>
    </div>
    <div>
        <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="input-group">
                    <asp:TextBox ID="txtFromDate" runat="server" MaxLength="10" BackColor="White" CssClass="form-control"
                        placeholder="DD/MM/YYYY" ValidationGroup="show" ToolTip="Date of Birth format should be DD/MM/YYYY"></asp:TextBox>
            ...
            <div class="col-md-2">
                <div class="input-group">
                    <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control" MaxLength="10"
                        placeholder="DD/MM/YYYY" ValidationGroup="show" ToolTip="Date of Birth format should be DD/MM/YYYY"
        ...
        <div class="form-group">
            <div class="col-md-3">
                <asp:Button ID="Button3" runat="server" Text="Click Here To Make Royalty Income"
                    OnClientClick="return validateAndConfirm('Do you really want to make Royalty income?')"
