<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockPrintBill.aspx.cs" Inherits="admin_StockPrintBill" %>
                ...
                <table style="width: 100%; text-align: left;" class="withclass">
                    ...
                    <tr id="tblBillHeader">
                        <td style="text-align: left; vertical-align: top; width: 50%;">
                            <%-- To Distributor No. :
                            <asp:Label ID="txtUserDisp" runat="server"></asp:Label>
                            <br />--%>
                        ...
                        <td style="text-align: left; width: 70%;" class="boder_righ">
                            <span class="term_condition"><b>Terms & Conditions</b>
                                <ol type="1">
                                    ...
                                    <li>All Disputes are subject to jurisdiction of
