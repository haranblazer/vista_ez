<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Template_Tour.aspx.cs" Inherits="Template_Tour" %>
                                                ...
                                                <div style="padding-left: 157px; padding-top: 166px;">
                                                    <table>
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <%-- <img src="images/<%=BackGroundImg%>" style="height: 401px; width: 400px; border-width: 0px;" />--%>
