...
public partial class admin_AssociateBill : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("cancel"))
        {
            ...
            catch
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "alert('Bill Items is Too Much higher then Franchise Stock');window.location='billinglist.aspx';", true);
            }
