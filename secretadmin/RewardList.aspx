<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="MasterPage.master" EnableEventValidation="false" CodeFile="RewardList.aspx.cs" Inherits="admin_rewards" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="130">
            ...
            <tr>
                <td colspan="3" style="border-top-width: 1px; border-left-width: 1px; border-left-color: blue;
                    ...
                    <asp:Button ID="btnsendaward" runat="server" BackColor="#2881A2" BorderColor="Black"
                        BorderStyle="Solid" BorderWidth="1px" Visible ="true" 
                         Font-Bold="True" ForeColor="White" OnClick="btnsendaward_Click"
                        Text="Dispatch Reward"
                        Width="118px" /><asp:Image ID="Image1" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/admin_images/excel.gif" /><asp:Button
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                          <asp:BoundField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" DataField="srno" HeaderText="SrNo." />
                            ...
                            <asp:BoundField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" DataField ="AwardAchivedDate" HeaderText ="Award Achived Date" />
                            <asp:TemplateField ItemStyle-HorizontalAlign="Left">
                            <HeaderTemplate> <asp:CheckBox ID="chkHeader" AutoPostBack="true" OnCheckedChanged="chkme" runat="server" /></HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblcheckid" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AppMstRegNo") %>'
