<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="returnitem.aspx.cs" Inherits="secretadmin_returnitem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <asp:HyperLinkField DataTextField="invoiceno" HeaderText="Invoice No." DataNavigateUrlFields="srno,status"
                ...
                <asp:BoundField HeaderText="User Id" DataField="appmstregno" ><ItemStyle HorizontalAlign="Left"></ItemStyle></asp:BoundField>
                <asp:BoundField HeaderText="Name" DataField="appmstfname" ><ItemStyle HorizontalAlign="Left"></ItemStyle></asp:BoundField>
