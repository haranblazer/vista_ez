<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="AssociateBill.aspx.cs" Inherits="admin_AssociateBill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="clearfix"> </div> <br />
        ...
        <label for="MainContent_txtPassword" class="col-sm-1 col-xs-3 control-label">From</label>
        <div class="col-sm-2 col-xs-9" style="margin-bottom:15px;">
             <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
     <div>
        <label for="MainContent_txtPassword" class="col-sm-1 col-xs-3 control-label">To</label>
    ...
    <br />
     <div>
        <label for="MainContent_txtPassword" class="col-sm-1 col-xs-3 control-label">Bill Type</label>
      <div class="col-sm-2 col-xs-9" style="margin-bottom:15px;">
     ...
     <div>
        <label for="MainContent_txtPassword" class="col-sm-1 col-xs-3 control-label">InvNo/UserID/Name</label>
        <div class="col-sm-2 col-xs-9">
    ...
    <div>
        <div class="col-sm-1" id="divUserID" style="display: none;" runat="server"></div>
    </div>
    <div class="clearfix"></div>
    <br />
    ...
    <div class="table-responsive">
                <asp:GridView AllowPaging="true" ID="GridView1" runat="server" CssClass="table table-striped table-hover mygrd" AutoGenerateColumns="false"
                    DataKeyNames="invoiceno,monthname" PageSize="50" Width="100%" OnPageIndexChanging="GridView1_PageIndexChanging"
