...
public partial class secretadmin_PoolIncome : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (fromDate <= toDate)
            {
                ...
                com = new SqlCommand("Poolincome", con);
                ...
                {
                    con.Close();
                    utility.MessageBox(this, "Pool Income Created Successfully");
                }
                else
                {
                    con.Close();
