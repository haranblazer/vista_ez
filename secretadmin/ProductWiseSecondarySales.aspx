<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="ProductWiseSecondarySales.aspx.cs" Inherits="secretadmin_ProductWiseSecondarySales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="table-responsive">
       ...
       <%-- <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CellPadding="4" CssClass="table table-striped table-hover"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Unit Purchase Rate" DataField="PurchaseRate" ItemStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField HeaderText="Total Sales Value" DataField="SalesValue" ItemStyle-HorizontalAlign="Right" />
            </Columns>
        </asp:GridView>--%>
    ...
    <script type="text/javascript">
        var pageUrl = '<%=ResolveUrl("ProductWiseSecondarySales.aspx")%>';
        $JDT(function () {
            BindTable();
        });
                ...
                success: function (data) {
                    ...
                    $JDT('#tblList').DataTable({
                        ...
                        columns: [
                            ...
                            { title: "O <br>Qty" },
                            { title: "Total <br>Qty" },
                            { title: "Unit <br>Pur.<br>Rate" },

                            { title: "Total <br> Pur.<br>value" },
                            { title: "Sales <br>Qty" },
                            { title: "Assoc.<br>Rate" },
                            { title: "Total <br> Sales <br> Value" },
                        ],
