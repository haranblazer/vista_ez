<%@ Page Title="" Language="C#" MasterPageFile="~/secretadmin/MasterPage.master" AutoEventWireup="true" CodeFile="RepurchaseReport.aspx.cs" Inherits="secretadmin_RepurchaseReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

 <h2 class="head">
            <i class="fa fa-search" aria-hidden="true"></i>&nbsp;(Repurchase Payout) Profit/Loss Report...</h2>
