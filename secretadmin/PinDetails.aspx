<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="PinDetails.aspx.cs" Inherits="tohadmin_PinDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <cc1:PagingGridView AllowPaging="true" EmptyDataText="No Pins Alloted !" CssClass="mygrd"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="PIN_SERIAL_NO." DataField="Pinsrno" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="70"/>
            ...
            <asp:BoundField DataField="transactionNo" HeaderText="TRANSACTION_NO" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="bank" HeaderText="BANK" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="depositedamount" HeaderText="DEPOSITED_AMOUNT" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100"/>
