<%@ Page Title="" Language="C#" MasterPageFile="~/secretadmin/MasterPage.master"
    AutoEventWireup="true" CodeFile="AssociatePackagecancelled.aspx.cs" Inherits="secretadmin_AssociatePackagecancelled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h2 class="head">
        <i class="fa fa-ban" aria-hidden="true"></i>&nbsp;Associate Package Cancelled Bill</h2>
    <div>
        ...
        <div class="col-sm-2 " style="margin-bottom: 15px;">
            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control">
                ...
                <asp:ListItem Value="1" Selected="True">Package </asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="col-sm-1 ">
