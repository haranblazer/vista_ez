...
public partial class secretadmin_DashboardDetailStateWise : System.Web.UI.Page
{
    ...
    protected void Grid_State_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            if (e.CommandName.Equals("State"))
            {
                ...
                Response.Redirect("DashboardInvDetails.aspx?Key="+MasterKey+"&state=" + state+"&From="+From+"&To="+To);
            }
        }
        catch (Exception ex)
        {
