...
public partial class admin_TotalOut : System.Web.UI.Page
{
    ...
    private void bindgrid(int bid, int pid)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblNoP.Text = "No of Products:" + dt.Compute("sum(totalout)", "true");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "OUTBill")
        {
            Response.Redirect("TotalCancelOutBill.aspx?pid=" + objUtil.base64Encode(pid) + "&sid=" + objUtil.base64Encode(sid) + "&stof=" + objUtil.base64Encode(soldToFlag) + "&sbyf=" + objUtil.base64Encode(soldbyFlag) + "&bby=O");
        }
    }
}