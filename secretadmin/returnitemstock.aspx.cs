...
public partial class secretadmin_returnitem : System.Web.UI.Page
{
    ...
    private void BindForPrint(string InvoiceNo)
    {
        ...
        try
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("ReturnSearchStkInv", con);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                ddlpaytype.SelectedItem.Text = dt.Rows[0]["paymode"].ToString();
    ...
    private void bindgrid()
    {
        ...
        DataTable dt;
        con = new SqlConnection(method.str);
        SqlDataAdapter ad = new SqlDataAdapter("getreturnitemliststock", con);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            con = new SqlConnection(method.str);
            SqlCommand cmd = new SqlCommand("AddReturnItemStock", con);
