<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true"
    CodeFile="PaymentReport.aspx.cs" Inherits="admin_PaymentReport" Title="Payout Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h4 class="fs-20 font-w600  me-auto float-left mb-0">First Purchase Payout</h4>
    <div class="row">
        <div class="col-sm-2">
    ...
    <div class="table-responsive" style="border: none">
        <table class="table table-striped table-hover">
            <tr style="border: 1px solid #ddd;">
                ...
                <td class="top_table">Total <%=method.BINARY_PV%> Generated
                </td>

                <td class="top_table">Total Commissionable Value
                </td>
    ...
    <div class="bottom_table">
        <div class="form-group" style="display: none">
            ...
            <div class="col-md-3 downlist" style="display: none">
                <asp:Button ID="btnCal" runat="server" Text="Submit" OnClick="btnCal_Click" CssClass="btn btn-success" />
            </div>
        </div>
    </div>
    <div class="clearfix">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped table-hover">
            <tr>
                ...
                <td style="padding-right: 20px; width: 25%; height: 25px; text-align: left" class="top_table">
                    <span style="font-size: 14px; font-family: Arial;"><strong>% of <%=method.BINARY_PV%></strong></span>
                </td>
            </tr>

            <tr>
                <td style="padding-left: 20px; width: 25%; height: 25px;">
                    <span style="font-size: 10pt; font-family: Arial">Active Bonus</span>
                </td>
            ...
            <tr>
                <td style="padding-left: 20px; width: 25%; height: 25px;">
                    <span style="font-size: 10pt; font-family: Arial">Self Help Club Bonus</span>
                </td>

                <td style="padding-right: 20px; width: 25%; height: 25px; text-align: left;">
                    <asp:Label ID="lbl_SelfHelpInc" runat="server" Width="120px"></asp:Label>
                </td>
                <td style="padding-right: 20px; width: 25%; height: 25px; text-align: left;">
                    <asp:Label ID="lblSelfHelppercent" runat="server" Font-Names="Arial" Font-Size="10pt">0</asp:Label>
                </td>
            </tr>
