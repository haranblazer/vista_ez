<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="AddRoyality_Retail_Booster_Details.aspx.cs" Inherits="AddRoyality_Retail_Booster_Details" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
    <h4 class="fs-20 font-w600  me-auto float-left mb-0">Create Loyalty Retail Booster Offer</h4>
    <div class="row">
         <div class="col-md-8"></div>
         <div class="col-md-4">
            <a href="AddRoyality_Retail_Booster.aspx" class="btn btn-link pull-right">Loyalty Retail Booster List</a>
        </div>
        <div class="clear"></div>
