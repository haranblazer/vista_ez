...
public partial class secretadmin_LoyaltyWallet : System.Web.UI.Page
{
    ...
    public void Bind()
    {
        try
        {
            ...
            da = new SqlDataAdapter("GetRoyaltyAdminwallet", con);
            con.Open();
    ...
    protected void imgbtnExcel_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_LoyaltyWallet.xls");
        Response.Charset = "";
