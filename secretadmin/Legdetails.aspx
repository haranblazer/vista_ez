<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Legdetails.aspx.cs" Inherits="secretadmin_Legdetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <h2 class="head">
            <i class="fa fa-list" aria-hidden="true"></i>&nbsp;Legwise Report
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" CssClass="table table-striped table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Cum RPV" DataField="RPV" />
