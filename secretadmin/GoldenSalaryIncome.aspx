<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoldenSalaryIncome.aspx.cs" Inherits="Keyadmin_GoldenSalaryIncome" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Golden Salary Income</title>
</head>
<body>
    ...
    <table align="center" style="width: 730px" cellspacing="0"  >
        <tr>
            <td style="text-align: center; height: 26px; background-color: #2881a2;">
                <strong><span style="font-family: Arial; color: #ffffff;">Golden Salary Income Qualifier's
                    List</span></strong></td>
        </tr>
         <tr>
             <td style="height: 23px; text-align: center"><table align="center" border="0" bordercolor="black" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr id="tr2">
                                                            <td align="center" colspan="2" valign="middle" style="text-align: center; height: 9px;">
                                                                <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" Text="Show List"
                                                                    ...
                                                                    Font-Bold="True" ForeColor="White" ValidationGroup="s" /></tr>
                                                    </table>
             </td>
         </tr>
         <tr>
...
<%#Container.DataItemIndex+1 %>
  ...
  <asp:BoundField 
                           ...
                           <asp:BoundField 
                           DataField="doe" HeaderText="Date of Qualification">
                               <ItemStyle HorizontalAlign="Left" />
                               <HeaderStyle HorizontalAlign="Left" />
                           </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="rank" 
                                                ...
                                                <HeaderStyle HorizontalAlign="Left" />
                                                     ...
                                                     <asp:BoundField 
                                                DataField="iselegible" HeaderText="Status">
                                                         <ItemStyle HorizontalAlign="Left" />
                                                         <HeaderStyle HorizontalAlign="Left" />
                                                     </asp:BoundField>
