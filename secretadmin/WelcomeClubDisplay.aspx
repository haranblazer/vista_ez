<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WelcomeClubDisplay.aspx.cs" Inherits="Keyadmin_GoldenSalaryIncome" %>
    ...
    <table align="center" style="width: 730px" cellspacing="0"  >
        <tr>
            <td style="text-align: center; height: 26px; background-color: #2881a2;">
                <strong><span style="font-family: Arial; color: #ffffff;">Welcome Club Income Qualifier's
                    List</span></strong></td>
        </tr>
         <tr>
        ...
        <tr>
            <td style="height: 23px; text-align: center">
                <asp:RadioButton ID="rdbtnActive" 
                 ValidationGroup ="chk"
                 GroupName ="aa"
                runat="server" Checked="True" Text="Active" />
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <asp:RadioButton ID="rdbtnNotActive" 
                   GroupName ="aa"
                runat="server" Text="Not Active"
                 ValidationGroup ="chk" 
                ...
                ID="rdbtnCompleat" runat="server" Text="Completed" 
                 GroupName ="aa"
                ValidationGroup ="chk" 
