<%@ Page Title="" Language="C#" MasterPageFile="~/secretadmin/MasterPage.master"
    AutoEventWireup="true" CodeFile="AssociateRepurchaseCancelled.aspx.cs" Inherits="secretadmin_AssociateRepurchaseCancelled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h2 class="head">
        <i class="fa fa-ban" aria-hidden="true"></i>&nbsp;Associate Repurchase Cancelled
        Bill</h2>
        <br />
    <div>
