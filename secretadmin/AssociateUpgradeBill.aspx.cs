...
using System.Xml;
public partial class secretadmin_AssociateUpgradeBill : System.Web.UI.Page
{
    DataTable dt = null;
        ...
        if (e.CommandName.Equals("cancel"))
        {
            ...
            try
            {
                    ...
                    if (status2 == "1")
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "alert('Bill cancel Successfully.');window.location='AssociateUpgradeBill.aspx.aspx';", true);
