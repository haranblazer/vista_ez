...
public partial class secretadmin_ReturnSalesList : System.Web.UI.Page
{
    ...
    public static UserDetails[] DataTable(string Regno, string min, string max, string Sessionid)
    {
        ...
        try
        {
            ...
            while (dr.Read())
            {
                ...
                data.NoOFProduct = dr["ProdCount"].ToString();
    ...
    //        SqlParameter[] param = new SqlParameter[]
    //      {
    //             new SqlParameter("@Regno", txt_ToId.Text),
    //             new SqlParameter("@min", strmin),
    //             new SqlParameter("@max", strmax),
    //             new SqlParameter("@Sessionid", txt_FromId.Text)
    //      };
    //        DataUtility objDu = new DataUtility();
    ...
    //            //row["tbl"] = strDtl;
    //        }
    //        GridView1.Columns[7].FooterText = dt.Compute("sum(ProdCount)", "true").ToString();
    //        GridView1.Columns[8].FooterText = dt.Compute("sum(Actual_Qty)", "true").ToString();
    //        GridView1.Columns[9].FooterText = dt.Compute("sum(DP)", "true").ToString();
    //        GridView1.Columns[10].FooterText = dt.Compute("sum(SGST)", "true").ToString();
    //        GridView1.Columns[11].FooterText = dt.Compute("sum(CGST)", "true").ToString();
    //        GridView1.Columns[12].FooterText = dt.Compute("sum(IGST)", "true").ToString();
    //        GridView1.Columns[13].FooterText = dt.Compute("sum(DPWithTax)", "true").ToString();
    //        GridView1.Columns[14].FooterText = dt.Compute("sum(Courier_Charges)", "true").ToString();
    //        GridView1.Columns[15].FooterText = dt.Compute("sum(InvoiceValue)", "true").ToString();
    ...
    //    Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_SalesReturnList.xls");
    //    Response.Charset = "";
