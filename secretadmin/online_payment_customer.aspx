<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="online_payment_customer.aspx.cs" 
    Inherits="secretadmin_online_payment_customer" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <script src="datepick/jquery-1.4.2.min.js" type="text/javascript"></script> 
    ...
    <script type="text/javascript"> 
     ...
     <h4 class="fs-20 font-w600  me-auto float-left mb-0">Customer Orders</h4>
    <div class="row">
                   <div class="col-sm-2">
        ...
        <div class="table-responsive">
            <asp:GridView ID="dglst" runat="server" AllowPaging="True" CellPadding="1" CssClass="table table-striped table-hover"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="srno_Encript" HeaderText="Order No."
                    ...
                    <asp:TemplateField HeaderText="	Invoice No." ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate> 
                          ...
                          <%--  <asp:LinkButton ID="lnk_ViewDetail" runat="server" Text='View Detail' CommandName="ViewDetail" Style="color: blue;" 
                                CommandArgument='<%#((GridViewRow)Container).RowIndex %>'></asp:LinkButton>--%>
                            <asp:LinkButton ID="LinkButton1" Text='<%#Eval("invoiceno") %>' runat="server"
                                CommandName="Invoice" CommandArgument='<%#((GridViewRow)Container).RowIndex %>' />
                    ...
                    <asp:BoundField DataField="CustomerName" HeaderText="Buyer Name" />
