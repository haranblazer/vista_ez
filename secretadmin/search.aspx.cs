...
public partial class admin_search : System.Web.UI.Page
{
    ...
    private void BindAutocomplete()
    {
        ...
        try
        {
            ...
            da = new SqlDataAdapter("select AppMstregno,AppMstLogin,AppmstFName,AppMstLName,AppMstMobile,AppMstCity,AppmstState,panno, from appmst order by appmstid", con);
            da.Fill(tbl);
    ...
    public void go1()
    {
        ...
        try
        {
            ...
            da = new SqlDataAdapter("SearchListMember", con);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
            da.SelectCommand.Parameters.AddWithValue("@regno", txtuname.Text.Trim());
    ...
    {
        txtuname.Text = txtstate.Text = txtfname.Text = txtcity.Text =  txtlname.Text = txtPan.Text = string.Empty;
