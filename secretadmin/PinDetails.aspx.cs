...
public partial class tohadmin_PinDetails : System.Web.UI.Page
{
    string tranid,id;
    ...
    public void bindGrid()
    {
        ...
        da = new SqlDataAdapter("getPinDetails", con);
        da.SelectCommand.CommandType = CommandType.StoredProcedure;
        da.SelectCommand.Parameters.AddWithValue("@tranid", tranid);
