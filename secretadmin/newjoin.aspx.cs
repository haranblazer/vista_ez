...
public partial class newjoin : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static Results UserRegistration(string Userid, string SponsorId, string Position, string Title, string Name, string state, string Gtitle, string GName, string Mobile,
    string Email, string Password, string epassword, string District, string City, string Pincode, string Address)
    {
        ...
        if (Userid == "")
        {
            objResult.Error = "Please Enter Userid.";
            return objResult;
        }
        if (SponsorId == "")
        {
        ...
        try
        {
            ...
            com.Parameters.AddWithValue("@FormNo", Userid);
            ...
            if (status == "1")
            {
                ...
                //string Text_Msg = "Dear " + Name + " Sign Up Successful ID no " + AppMstRegNo + " Password " + Password;
               ...
               // objUtil.sendSMSByBilling(Mobile, Text_Msg);

                objResult.Regno =  AppMstRegNo;
