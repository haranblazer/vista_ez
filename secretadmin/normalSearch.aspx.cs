...
public partial class admin_normalSearch : System.Web.UI.Page
{
    ...
    public static UserDetails[] BindTable(string min, string max, string regno, string AppMstFName, string AppMstMobile, string District, string AppMstCity, string AppMstState, string panno, string IsPaid, string IsActive, string IsTopper)
    {
