                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        data.d[i].cfl,
                            ...
                            data.d[i].Highest_Leg_1,
                            data.d[i].Highest_Leg_2,
                            data.d[i].Rest_Legs, 
                    ...
                    */
                    ...
                    $JDT('#tblList').DataTable({
                        ...
                        columns: [
                            ...
                            { title: "<%=method.PV %>" },
                            { title: "<%=method.GBV %>" },
                            { title: "Matched <%=method.PV %>" },
                            { title: "Carry Left" },
                            { title: "Carry Right" },

                            { title: "Total Matched Left" },
                            { title: "Total Matched Right" },
                            { title: "Brought Forword Left" },
                            { title: "Brought Forword Right" },
                            { title: "Self Repurchase BV" },
                            { title: "First Purchase BV" },
                            { title: "Highest Downline BV" },
                            { title: "Second Highest BV" },
                            { title: "Rest of Legs BV" }, 
                          /*  data.d[i].CPL,
                            data.d[i].CPR,
                            data.d[i].bfl,
                            data.d[i].bfr,
                        ...
                        "footerCallback": function (row, data, start, end, display) {
                            ...
                            $(api.column(12).footer()).html(api.column(11).data().reduce(function (a, b) { return intVal(a) + intVal(b) }, 0));
