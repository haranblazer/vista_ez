...
public partial class member_Changeprofile : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            str1 = Convert.ToString(Session["MemberId"]);
            hfuserid.Value = Convert.ToString(Session["MemberId"]);
    ...
    private void CheckStatus()
    {
        ...
        where a.AppMstRegNo='" + Session["MemberId"] + "'";
                ...
                if (!string.IsNullOrEmpty(filePath))
                {
                    ...
                    try
                    {
                        ...
                        if (filesize < 500000)
                        {
                            ...
                            string usrId = Session["MemberId"].ToString();
    ...
    public static string generateOTP()
    {
        ...
        da.SelectCommand.Parameters.AddWithValue("@RegNo", HttpContext.Current.Session["MemberId"].ToString());
    ...
    public static string btnRejectKYC_Click(string kycid)
    {
        ...
        SqlParameter[] prm = new SqlParameter[] { new SqlParameter("@Userid1", HttpContext.Current.Session["MemberId"].ToString()) };

        SqlParameter[] param = new SqlParameter[] { new SqlParameter("@Userid", HttpContext.Current.Session["MemberId"].ToString()) };
        ...
        if (kycid == "1")
        {
            try
            {
                ...
                {
                    outparam,
                    new SqlParameter("@regno", HttpContext.Current.Session["MemberId"].ToString()),
                    new SqlParameter("@modifiedby", HttpContext.Current.Session["MemberId"].ToString()),
    ...
    public static string verifyOTP(string telno, string txtotp)
    {
        ...
        SqlCommand com = new SqlCommand("VerifyOTP", con);
        com.CommandType = CommandType.StoredProcedure;
        com.Parameters.AddWithValue("@RegNo", HttpContext.Current.Session["MemberId"].ToString());
    ...
    public void bankdetail()
    {
        ...
        {
            con = new SqlConnection(method.str);
            SqlCommand cmd = new SqlCommand("select bankname,acountno,branch,ifscode,type from appmst where appmstregno='" + Session["MemberId"].ToString() + "' ", con);
            SqlDataReader sdr;
            con.Open();
