...
public partial class member_UpdateProfilePic : System.Web.UI.Page
{
    ...
    private void go()
    {
        try
        {
            ...
            string queryr = "select imagename from Appmst where AppMstRegNo='" + Session["MemberId"] + "'";
    ...
    protected void btnReject_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string upStatus = "Update appmst set imagename='noimage.png' from  AppMst where AppMstRegNo ='" + Session["MemberId"] + "'";
