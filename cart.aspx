...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="checkout-form">
                        ...
                        <div class="row">
                            <div class="col-xl-12 form-group">
                                <asp:RadioButtonList ID="rdo_UserType" runat="server" onchange="UserType();" RepeatDirection="Horizontal">
                                    <asp:ListItem Selected="True" Value="0">&nbsp;EZ Partner &nbsp; </asp:ListItem>
                                    <asp:ListItem Value="1">&nbsp;Preferred Customer</asp:ListItem>
                                </asp:RadioButtonList>
                            ...
                            <div class="col-xl-12 form-group">
                                <asp:TextBox ID="txt_Mobile" runat="server" CssClass="form-control" placeholder="Enter Your Mobile No." MaxLength="10"></asp:TextBox>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6 form-group">
                                <asp:DropDownList ID="ddlpaytype" runat="server" CssClass="form-control">
                                   ...
                                   <%-- <asp:ListItem Value="1">Cash</asp:ListItem> --%> 
                                    <asp:ListItem Value="17">PhonePe</asp:ListItem>
                                    <%--<asp:ListItem Value="15">UPI</asp:ListItem>
                ...
                <div id="div_ProdDetails2" class="col-xl-6">
                    <div class="checkout-form">
                        ...
                        <div class="row">
                            ...
                            <div class="clearfix"></div>
                            <div class="col-8 pb-2"><span id="lbl_BVType" class="form-control"><%=method.PV %></span></div>
                            <div class="col-4 pb-2 text-end">
                                <asp:Label ID="lbl_TotalBV" runat="server" CssClass="control-label form-control">0</asp:Label>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-8 pb-2"><span class="form-control">Gross Value</span></div>
                            <div class="col-4 pb-2 text-end">
                                <asp:Label ID="lbl_Gross" runat="server" CssClass="control-label form-control">0</asp:Label>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-8 pb-2 d-none"><span class="form-control">Billing Value</span></div>
                            <div class="col-4 pb-2 text-end d-none">
                                <asp:Label ID="lbl_Prod_Val" runat="server" CssClass="control-label form-control">0
                                </asp:Label>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="clearfix"></div>
                            <div class="col-8 pb-2 d-none"><span class="form-control">Scheme</span></div>
                            <div class="col-4 pb-2 text-end d-none">
                            ...
                            <div class="col-8 pb-2"><span class="form-control">Select Pickup Type</span></div>
        ...
        function BindCartTable() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#tblList').append("<th>GST Value</th>");
                    $('#tblList').append("<th>Sale Value</th>");
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        //
                        tbl += '<td data-title="Price">' + data.d[i].Gross + '</td>';
                    ...
                    tbl += "<thead><tr><th></th> <th>Total :</th><th>" + TotalQty + "</th>   <th>" + TotalAmt.toFixed(2) + "</th> <th>" + TotalGST.toFixed(2) + "</th> <th>" + NetAmt.toFixed(2) + "</th> <th></th> </tr></thead>";
                    $('#tblList').append(tbl);
                    ...
                    $('#<%=lbl_DeliveryAmount.ClientID%>').text(DeliveryCharge); 
                    ...
                    if (data.d.length > 0) {
                        /* Show Calculation */
                        //$('#<%=lbl_Gross.ClientID%>').text(TotalAmt.toFixed(2));
                        $('#<%=txt_Discount.ClientID%>').val(TotalDiscount.toFixed(2));

                        $('#<%=lbl_Gross.ClientID%>').text(TotalGross.toFixed(2));
                        $('#hnd_TotalGross').val(Math.round(TotalGross.toFixed(2)));


                        NetAmt = parseFloat(TotalAmt.toFixed(2)) + parseFloat(TotalGST.toFixed(2));
        ...
        function Update_Discount_Delcharge() {
           ...
           <%-- var delCharge = $('#<%=txt_DelCharge.ClientID%>').val();
            ...
            if ($('#<%=ddl_PickupType.ClientID%>').val() == "1") {
                delCharge = Calc_Delivery_Charge($('#hnd_TotalAmt').val());
            ...
            let TotalInv = (parseFloat($('#<%=lbl_Gross.ClientID%>').text()) + parseFloat($('#<%=lbl_Gst_Amt.ClientID%>').text()));
    ...
    <script type="text/javascript">
        ...
        function Generate_Inv() {
            ...
            let UserType = $("input[name='<%=rdo_UserType.UniqueID%>']:radio:checked").val();
            if (UserType == "0") {
                if (UserId == "") {
            ...
            $.ajax({
                ...
                data: '{PackStockType: "' + PackStockType + '", BillType: "' + BillType + '", UserId: "' + UserId
                    ...
                    + '", Adjustment: "' + Adjustment + '", PaymodeVal: "' + PaymodeVal + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    ...
                    if (data.d.Error == "") {
                        ...
                        if (PaymodeVal == "1") {
                            alert("Your Order Generated Successfully. Order Number is : " + data.d.InvoiceNo);
                            window.location = "products";
                        }

                        if (PaymodeVal == "17") {
                            window.location = "phonepe_req?id=" + data.d.InvoiceNo;
                        } 
                ...
                success: function (data) {
                    if (data.d.Error == "") {
                        ...
                        <%--if (data.d.IsCustomer == "True") {
                            ...
                            $('#lbl_UserDetails').text(Associate);
                        }--%>
        ...
        function UserType() {
            GetUserTypeVal($("input[name='<%=rdo_UserType.UniqueID%>']:radio:checked").val());
        }


        function GetUserTypeVal(UserTypeVal) {
            $.ajax({
                type: "POST",
                url: 'cart.aspx/UserType',
                data: "{'UserTypeVal':'" + UserTypeVal + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    $('#<%=rdo_UserType.ClientID %>').find("input[value='" + data.d + "']").prop("checked", true);
                    if (data.d == "0" && $('#<%=txt_Userid.ClientID%>').val() == "") {
                        $('#<%=txtName.ClientID %>').attr('disabled', true);
                        $('#<%=txtaddress.ClientID %>').attr('disabled', true);
                        $('#<%=ddl_state.ClientID %>').attr('disabled', true);
                        $('#<%=ddl_district.ClientID %>').attr('disabled', true);
                        ...
                        $('#<%=ddl_state.ClientID %>').attr('disabled', false);
                        $('#<%=ddl_district.ClientID %>').attr('disabled', false);
                        $('#<%=txtCity.ClientID %>').attr('disabled', false);
                        $('#<%=txtPincode.ClientID %>').attr('disabled', false);
                        $('#<%=txt_Mobile.ClientID %>').attr('disabled', false);
                    }
                },
