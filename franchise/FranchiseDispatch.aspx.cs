...
public partial class franchise_FranchiseDispatch : System.Web.UI.Page
{
    ...
    private void BindDetail(string srno)
    {
        ...
        DataTable dt = objDu.GetDataTableSP(param1, "GetDispatchData");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["CheckRefresh"].ToString() == ViewState["CheckRefresh"].ToString())
            {
                ...
                DataUtility objDu = new DataUtility();
                DataTable dt = objDu.GetDataTableSP(param, "Update_Fran_Dispatch");
                if (dt.Rows.Count > 0)
                {
