<%@ Page Title="" Language="C#" MasterPageFile="~/franchise/MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseOrderBill.aspx.cs" Inherits="franchise_PurchaseOrderBill" %>
    ...
    <asp:UpdatePanel ID="upnl" runat="server">
        <ContentTemplate>
            ...
            <div class="printdiv">
              ...
              <center>
                      <h3>===============================Purchase Order(PO)===========================</h3></center>
                            ...
                            <asp:Repeater ID="GridView1" runat="server"   >
                                ...
                                <FooterTemplate>
                                    <tr>
                                        ...
                                        <td class="footerstylebodder" align="left">
                                            Total:
                                        </td>
                                        <td class="footerstylebodder" align="left">
                ...
                <td  style="height:20px"></td>
                      ...
                      <th class="printmygrd th">GST Summary</th>

                      <th class="printmygrd th">Payment</th>


                      <th class="printmygrd th">Value</th>
                      </tr>
                                  ...
                                  <tr>
                                    ...
                                    <asp:Repeater ID="dglst" runat="server">
                                     <ItemTemplate>
                                               ...
                                               <td>        
                                                        <asp:Label ID="lblPackgName" runat="server" Text='<%#Eval("tax")%>'> </asp:Label></td>

                                                            
                                                        <td>
                                                            <asp:Label ID="lblQNT" runat="server"  
                                                                Text='<%#Eval("taxamount")%>'>0</asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 30%">
                            <b><span class="companyName">for
                                ...
                                <asp:Button ID="nextbill" runat="server" Text="Next Bill" CssClass="hide_class btn btn-success" PostBackUrl="BillingForm.aspx"
