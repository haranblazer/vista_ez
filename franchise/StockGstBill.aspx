<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockGstBill.aspx.cs" Inherits="secretadmin_StockGstBill" %>
                ...
                <td>
                    <table style="width: 100%">
                        <tr>
                            ...
                            <img src="../images/logo.png" class="img-responsive" title="Ocean India" alt="#" style=" margin-top:5px; margin-bottom:2px; height:70px; width:100px">
                            ...
                            <td style="width: 60%">
                                <div style="padding-left: 10px; padding-right: 10px; float: left">
                                    <b><asp:Label ID="lblcompanyname" runat="server"></asp:Label></b>
                                </div>
                    ...
                    <asp:Repeater ID="rp1" runat="server">
                        ...
                        <FooterTemplate>
                            <tr>
                                ...
                                <td style="width: 5%; font-size: 12px">
                                    <asp:Label ID="lbltotaldisc" runat="server" Style="font-weight: bold"></asp:Label>
                                </td>
                                <td style="width: 5%; font-size: 12px">
                ...
                <td>
                    ...
                    <table style="width: 100%;font-size:12px">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%">
                                <asp:Label ID="lblpaymode" runat="server" Text="Label"></asp:Label>
                            </td>
                            <td style="width: 20%">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%;">
                                <div style="text-align: left; font-size: 12px; margin-top: 5px; padding-left: 20px">
                                    FOR
                                    <b><asp:Label ID="lblcompanyname2" runat="server" Text="Label"></asp:Label></b>
                                </div>
