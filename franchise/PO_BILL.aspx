     ...
     <%--   <div class="right-sign">
       ...
       <div class="heading">Purchase Order</div>
        ...
        <header class="clearfix">
              ...
              <img src="../secretadmin/images/logo.png" class="logo">
            
              <div class="clearfix"></div><br /><br />  

            <div id="project">
            <div class="card-group-row row">
                 <div class="total-bold"> <span>CIN: <%=method.COMP_CINNO%> </span></div> 
             <div class="col-md-2 " style="font-weight: bold;"><span>FranchiseID : </span> <asp:Label id="lbl_Regno" runat="server"></asp:Label></div>
           </div>
              ...
              <div id="company" class="clearfix">
                ...
                <div>
                    <span style="font-weight: bold;">Tel : </span> <asp:Label id="lbl_UserMobileNo" runat="server"></asp:Label> 
                    <span style="font-weight: bold;">Email:</span>  <asp:Label id="lbl_UserEmail" runat="server"></asp:Label> 
                </div>
                
      
                <div><span style="font-weight: bold;">GSTIN :</span> <asp:Label id="lbl_UserGSTIN" runat="server"></asp:Label> <span style="font-weight: bold;">PAN :</span> <asp:Label id="lbl_UserPAN" runat="server"></asp:Label> </div>

                <div><span style="font-weight: bold;">CIN :</span> <asp:Label id="lbl_UserCIN" runat="server"></asp:Label> </div>

                <div><span style="font-weight: bold;">Order No. :</span> <asp:Label id="lbl_UserINVNo" runat="server"></asp:Label>  <span style="font-weight: bold;">Order Date :</span> <asp:Label id="lbl_UserINVDate" runat="server"></asp:Label> </div>
                <div><span style="font-weight: bold;">Date PO No. :</span>  <asp:Label id="lbl_User_Date_PO_NO" runat="server"></asp:Label>     <span style="font-weight: bold;">E-Way Bill No. : </span>    NA    </div>
                 
                  <div> <span style="font-weight: bold;">Deliver To:</span> <asp:Label id="lbl_DeliverTo" runat="server" style="width:100%;font-size:12px;"></asp:Label> </div> 
              </div>
    </header>
        ...
        <asp:Repeater ID="Repeater" runat="server">
                ...
                <table>
                    <tbody>
                        <tr style="background: #ddd;">
                            ...
                            <th class="total-bold">Qty.</th>
                            <th class="total-bold">Gross Value</th>
            ...
            <ItemTemplate>
                <tr> 
                    ...
                    <td class="total">  <%#Eval("tax") %>  </td>
                    <td class="total"> <%#Eval("TotalAmt") %>  </td>
                     <td class="total"> <%#Eval("BV") %>  </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
                <tr>
        ...
        <table style="width: 30%; margin-left: 2%; float: left">
            ...
            <tr>
                <td class="total-bold" style="border-bottom: none;">GST </td>
        ...
        <div style="width: 40%; float: left; margin-left: 5%; text-align:end; ">
