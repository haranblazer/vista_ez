...
public partial class franchise_CancelledBill : System.Web.UI.Page
{
    DataTable dt = null;
    ...
    private void BindGrid()
    {
        try
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("Franchisecancelledbillsearch", con);
            ...
            ad.SelectCommand.Parameters.AddWithValue("@regno", Session["franchiseid"].ToString());
            dt = new DataTable();
            ad.Fill(dt);
