    ...
    return {
        init: function () {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function () {
                ...
                }), n = window.outerHeight, ((n = window.outerHeight) > 0 ? n : screen.height) && $(".content-body").css("min-height", n + 60 + "px"), $('a[data-action="collapse"]').on("click", function (e) {
                ...
                function () {
                    ...
                    $(window).scroll(function () {
                        "horizontal" === $("body").attr("data-layout") && "static" === $("body").attr("data-header-position") && "fixed" === $("body").attr("data-sidebar-position") && ($(this.window).scrollTop() >= e ? $(".dlabnav").addClass("fixed") : $(".dlabnav").removeClass("fixed"))
                    })
                ...
                }), jQuery(".dlabnav-scroll").length > 0 && (new PerfectScrollbar(".dlabnav-scroll").isRtl = !1), $(".btn-number").on("click", function (e) {
                    ...
                    jQuery(this).toggleClass("active"), "password" == jQuery("#dlab-password").attr("type") ? jQuery("#dlab-password").attr("type", "text") : "text" == jQuery("#dlab-password").attr("type") && jQuery("#dlab-password").attr("type", "password")
        ...
        //    }, 800), jQuery(".default-select").length > 0 && jQuery(".default-select").niceSelect()
        //},
        resize: function () {
            t()
        },
        handleMenuPosition: function () {
            e > 1024 && $(".metismenu  li").unbind().each(function (e) {
                if ($("ul", this).length > 0) {
                    ...
                    if (jQuery("html").hasClass("rtl")) var o = t + n <= l;
                    else o = t > 0;
                    o ? $(this).find("ul:first").removeClass("left") : $(this).find("ul:first").addClass("left")
                }
            })
        }
    }
...
jQuery(document).ready(function () {
    $('[data-bs-toggle="popover"]').popover(), Jobick.init()
}), jQuery(window).on("load", function () {
    "use strict";
    Jobick.load(), setTimeout(function () {
        Jobick.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function () {
    "use strict";
    Jobick.resize(), setTimeout(function () {
        Jobick.handleMenuPosition()
    }, 1e3)
});