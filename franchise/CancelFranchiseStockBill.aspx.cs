...
public partial class franchise_CancelFranchiseStockBill : System.Web.UI.Page
{
    DataTable dt = null;
    ...
    private void BindGrid()
    {
        try
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("FranchisecancelledStocksearch", con);
            ...
            ad.SelectCommand.Parameters.AddWithValue("@regno",1);
            dt = new DataTable();
            ad.Fill(dt);
