...
public partial class franchise_TotalCancel: System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter da;
    DataTable dt;
    ...
    protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        DataTable dt = (DataTable)ViewState["TotalCancel"];
        GridView1.DataSource = dt;
        GridView1.DataBind();
    }
    ...
    protected void ImageButton_Click(object sender, ImageClickEventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_TotalCancelStock.xls");
            Response.Charset = "";
    ...
    protected void imgbtnWord_Click(object sender, ImageClickEventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_TotalCancelStock.doc");
