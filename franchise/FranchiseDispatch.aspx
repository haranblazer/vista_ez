<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="FranchiseDispatch.aspx.cs" Inherits="franchise_FranchiseDispatch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        $(function () {
           ...
           // $('#<%=dvPreview.ClientID%>').html("<img src='~/images/Slip/noimage.png' style='height:112px; width:105px'/>");
    ...
    <h2 class="head">
        <i class="fa fa-file-text-o"></i>&nbsp;Dispatch System
