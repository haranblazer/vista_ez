<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ReturnProduct.aspx.cs"
    EnableEventValidation="false" Inherits="franchise_ReturnProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h4 class="fs-20 font-w600  me-auto float-left mb-0">Franchise Return Product</h4>


    <div class="row">
        <div class="col-sm-1 col-form-label">From ID.</div>
        <div class="col-sm-2">
            <asp:TextBox ID="txt_FromId" runat="server" onchange="GetFromId();" CssClass="form-control"
                placeholder="Enter From Id" AutoPostBack="true" OnTextChanged="txt_FromId_TextChanged"></asp:TextBox>
            <span id="lbl_FromName" style="font-size: 10px;"></span>
        </div>
        <div class="col-sm-1 col-form-label">To ID.</div>
        <div class="col-sm-2">
            ...
            <div id="div_PaymentDetails" style="display: none;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-4">
                        ...
                        <asp:TextBox ID="txt_DelCharge" runat="server" CssClass="form-control text-left" Width="60px" onchange="Update_Discount_Delcharge()" Style="padding: 4px; float: left;">0.00</asp:TextBox>
                    </div>
                </div>
                <div class="clearfix">
                </div>
    ...
    <script type="text/javascript">
        ...
        function GetProduct() {
            ...
            var Productcode = $('#<%=txt_Barcode.ClientID%>').val();
                if (Productcode != '') {
                    var Userid = $('#<%=txt_FromId.ClientID%>').val();
                        if (Userid == '') {
            ...
            $('#<%=txt_Barcode.ClientID%>').val('');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#tblList').append("<th style='width: 19%; border-bottom: 1px dotted #d3d3d3; background-color:#fcddc3;'>Products</th>");
                        $('#tblList').append("<th style='width: 10%; border-bottom: 1px dotted #d3d3d3; background-color:#fcddc3;'>Batch No</th>");
                        $('#tblList').append("<th style='width: 5%; border-bottom: 1px dotted #d3d3d3; background-color:#fcddc3;'>Rate</th>");
                        $('#tblList').append("<th style='width: 12%; border-bottom: 1px dotted #d3d3d3; background-color:#fcddc3;'>Quantity</th>");
                        ...
                        $('#tblList').append("<th style='width: 8%; border-bottom: 1px dotted #d3d3d3; background-color:#fcddc3;'>Gross Amount</th>");
                        ...
                        tbl += '</tbody>';
                        tbl += "<thead><tr style='background-color:#fcddc3;'><th></th> <th>Total :</th>  <th></th> <th></th> <th>" + TotalQty + "</th> <th>" + TotalAmt.toFixed(2) + "</th>  <th> 0</th> <th> " + TotalTaxable.toFixed(2) + "</th> <th></th> <th>" + TotalGST.toFixed(2) + "</th> <th>" + NetAmt.toFixed(2) + "</th> <th></th> </tr></thead>";
                        $('#tblList').append(tbl);
                        $('#<%=txt_Barcode.ClientID%>').focus();
