...
public partial class franchise_WalletRequest : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand com;
    string regno;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            utility.MessageBox(this, "Please Enter Transaction No. !!");
            return;
        }
    ...
    private void Walletinsert()
    {
        ...
        try
        {
            com = new SqlCommand("Applyfranwalletrequest", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@requestId", btnSubmit.CommandName);
            com.Parameters.AddWithValue("@PregNo", regno);
            com.Parameters.AddWithValue("@PaymentType", rbtnlstMode.SelectedValue.Trim());
