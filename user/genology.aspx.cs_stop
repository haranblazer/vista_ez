...
public partial class user_genology : System.Web.UI.Page
{
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            if (t.Rows[i]["AppMstLeftRight"].ToString() == "0")
            {
               ...
               t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton2, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                ...
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 2);
            ...
            else
            {
              ...
              t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton3, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 3);
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            if (t.Rows[i]["AppMstLeftRight"].ToString() == "0")
            {
             ...
             t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton4, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 4);
            ...
            t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton5, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 5);
    ...
    public void rnext7(string str)
    {
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            if (t.Rows[i]["AppMstLeftRight"].ToString() == "0")
            {
                ...
                t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 6);
            ...
            else
            {
                ...
                t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 7);
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            if (t.Rows[i]["AppMstLeftRight"].ToString() == "0")
            {
             ...
             t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton8, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 8);
            ...
            t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton9, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 9);
    ...
    public void rnext11(string str)
    {
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            if (t.Rows[i]["AppMstLeftRight"].ToString() == "0")
            {
                ...
                t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 10);
            ...
            else
            {
                ...
                t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 11);
            }
        }
    }
    //}
    public void lnext11(string str)
    {
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            if (t.Rows[i]["AppMstLeftRight"].ToString() == "0")
            {
                ...
                t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 12);
            ...
            else
            {
                ...
                t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(), 13);
    ...
    public void rnext15(string str)
    {
        ...
        for (int i = 0; i < t.Rows.Count; i++)
        {
            ...
            t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton14, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(),14);
           ...
           t.Rows[i]["carryright"].ToString(), t.Rows[i]["totalnewleft"].ToString(), t.Rows[i]["totalnewright"].ToString(), t.Rows[i]["appmstpaid"].ToString(), t.Rows[i]["ypin"].ToString(), ImageButton15, t.Rows[i]["LeftRp"].ToString(), t.Rows[i]["RightRp"].ToString(),
                 t.Rows[i]["Rewardleft"].ToString(), t.Rows[i]["rewardright"].ToString(),
                t.Rows[i]["TourpointL"].ToString(), t.Rows[i]["TourpointR"].ToString(), t.Rows[i]["gbvamt"].ToString(), t.Rows[i]["pbvamt"].ToString(), t.Rows[i]["pbv"].ToString(), t.Rows[i]["gbv"].ToString(),15);
    ...
    public void imag1(string str, ImageButton ibtn, decimal joinfor, string paid, string ypin)
    {
        ...
        if (sdr.Read())
        {
            imgg = "~/user/images/" + sdr["image"].ToString();
            ibtn.ImageUrl = imgg;
            con.Close();
        }
        else
        {
            con.Close();
            if (paid == "1" || ypin == "1")
                imgg = "~/user/images/paid.gif";


            else
                imgg = "~/user/images/unpaid.gif";
            ibtn.ImageUrl = imgg;
        }
        con.Close();
    }
    ...
    private void BindHyperLink(HyperLink hlnk, string regno, string name, string joinfor, string appmstLeftTotal, string appmstRightTotal, string carryLeft, string carryRight, string totalNewLeft, string TotalNewRight, string paid, string ypin, ImageButton imgbtn, string LeftRP, string RightRP, string RWL, string RWR, string TourL, string TourR, string GBV, string PBV, string pbv1, string gbv1,int count)
    {
        ...
        div.InnerHtml = "<table   align='background-color:Blue' style='padding:0px;margin:0px background: #fbfcfd; font-size:13px;' >";


        //div.InnerHtml += "<tr><td>" + name + "</td><tr>";
        //if (hlnk == HyperLink1)
        //div.InnerHtml += "<tr ><td><a style='color:black' href='javascript:void'>" + regno + "</a></td><tr>";
        //  div.InnerHtml += "<tr ><td><a style='color:black' href='javascript:void'>" + name + "</a></td><tr>";
        //else

        div.InnerHtml += "<tr ><td ><a style='color:black' href='genology.aspx?n=" + obj.base64Encode(regno) + "&n1=" + obj.base64Encode(name) + "'>" + name + "</a></td><tr>";
        div.InnerHtml += "<tr ><td>";
        ...
        {
            div.InnerHtml += "<table class='table table-sm'   border='1'  id=" + tab;
        }
        ...
        div.InnerHtml += "<tr><td style='width:25%' >ID</td><td style='width:25%' >" + regno + "</td><td style='width:25%'>Name</td><td style='width:25%'>" + name + "</td></tr>";



        div.InnerHtml += "<tr ><td style='width:25%'>Left TCC</td><td style='width:25%'>" + appmstLeftTotal + "</td><td style='width:25%' >Right TCC</td><td style='width:25%'>" + appmstRightTotal + "</td></tr>";

        div.InnerHtml += "<tr ><td style='width:25%'>New Left TC</td><td style='width:25%'>" + totalNewLeft + "</td><td style='width:25%'>New Right TC</td><td style='width:25%'>" + TotalNewRight + "</td></tr>";


        div.InnerHtml += "<tr ><td style='width:25%' colspan='2'>Topper Type</td><td style='width:25%' colspan='2' >" + joinfor + "</td></tr>";
        ...
        if (paid == "1")
            imgbtn.ImageUrl = "images/paid13.png";
        else if (paid == "0" && ypin == "0")
            imgbtn.ImageUrl = "images/unpaid.png";
        else if (ypin == "1")
            imgbtn.ImageUrl = "images/paid12.png";
