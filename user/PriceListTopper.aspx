<%@ Page Title="" Language="C#" MasterPageFile="user.master" AutoEventWireup="true" CodeFile="PriceListTopper.aspx.cs" Inherits="User_PriceListTopper" %>

 
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <h4 class="fs-20 font-w600  me-auto float-left mb-0">Topper Price List</h4>
    <div class="row">
        <div class="col-sm-2">
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("PriceListTopper.aspx")%>';
        $JDT(function () {
            BindTable();
        });
