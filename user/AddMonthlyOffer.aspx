<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="AddMonthlyOffer.aspx.cs" Inherits="secretadmin_AddMonthlyOffer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#<%=txtExpDate.ClientID%>').datepick({ dateFormat: 'dd/mm/yyyy' });
            ProductVisible();
        });
    ...
    <h2 class="head">
        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Create Monthly Offer</h2>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddl_UserType" runat="server" CssClass="form-control" Onchange="ProductVisible();">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddl_BillType" runat="server" CssClass="form-control">
                            <asp:ListItem Value="0">All</asp:ListItem>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" EmptyDataText="Record not found." DataKeyNames="MId"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Offer Type" DataField="BillType" ReadOnly="True" />
