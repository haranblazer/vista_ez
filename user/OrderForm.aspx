    ...
    <asp:UpdatePanel ID="upnl" runat="server">
        <ContentTemplate>
            ...
            <div class="panel-heading">
                <i class="fa fa-edit" aria-hidden="true"></i>&nbsp;Order Form
            </div>
        ...
        <label for="MainContent_txtPassword" class="col-md-2 control-label">Delivery Address :</label>
                        ...
                        <asp:TextBox ID="txtAddress" TextMode="MultiLine" runat="server" Height="60px" CssClass="form-control"></asp:TextBox>
                   </div></div>
                   </div> </div>
            <br />
                    ...
                    <td>
                        <asp:GridView Width="100%" ID="GridView1" DataKeyNames="id" CssClass="mygrd" ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="RP Amout" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"
                                    FooterStyle-HorizontalAlign="Right">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Total" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"
                                    ...
                                    <ItemTemplate>
                                        <%#Eval("total") %>
                                        <%--<asp:TextBox ID="txtTotalP" Text='<%#Eval("total") %>' BackColor="Transparent" Enabled="false"   BorderStyle="None" ForeColor="Black"  Font-Bold="true"  runat="server"></asp:TextBox>
                                       DeleteImageUrl="../Admin_Images/Delete.png" --%>
                                    </ItemTemplate>
                                    <FooterTemplate>
