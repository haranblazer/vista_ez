<%@ Page Title="" Language="C#" MasterPageFile="user.master" AutoEventWireup="true" CodeFile="NotificationList.aspx.cs" Inherits="User_NotificationList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-sm-2 col-xs-3 text-right pull-right">
            <a href="AddNotification.aspx" class="btn btn-primary">Add Notification</a>
        </div>
    ...
    <script type="text/javascript">
        ...
        function BindTable() {
            ...
            $.ajax({
                ...
                data: '{fromDate: "' + fromDate + '", toDate: "' + toDate + '",AdminAPRVD: "' + AdminAPRVD + '"}',
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        if (data.d[i].AdminAPRVD == "True") {
                            AdminAPRVD = '<span class="dotGreen"></span>';
                        }
                        else {
                            AdminAPRVD = '<span class="dotGrey"></span>';
                        }
