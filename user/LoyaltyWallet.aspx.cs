...
public partial class User_LoyaltyWallet : System.Web.UI.Page
{
    ...
    public static UserDetails[] BindTable(string min, string max)
    {
        ...
        try
        {
            ...
            SqlDataReader dr = objDu.GetDataReaderSP(param, "GetLoyaltyPassbook");
            while (dr.Read())
            {
    ...
    //        Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("dd/MM/yyyy") + "_LoyaltyPassbook.xls");
    ...
    //            return;
    //        }
    //        da = new SqlDataAdapter("GetLoyaltyPassbook", con);
    //        con.Open();
