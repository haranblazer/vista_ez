<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.master" AutoEventWireup="true" CodeFile="TWallet.aspx.cs" Inherits="User_TWallet" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <h4 class="fs-20 font-w600  me-auto float-left mb-0">T-Wallet</h4>
   ...
   <script> var $JDT = $.noConflict(true); </script>
     ...
     <script type="text/javascript">
        var pageUrl = '<%=ResolveUrl("TWallet.aspx")%>';
         $JDT(function () {
            BindTable(); 
        });
