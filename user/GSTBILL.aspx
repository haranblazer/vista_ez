                            ...
                            <td style="width: 40%; vertical-align: top">
                                <table style="width: 100%" cellpadding="0px" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 50%">
                                            <asp:Label ID="lblcstatecode" runat="server" Text=" "></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 10%; font-size: 12px">
                                    ...
                                    <%# Eval("Scheme").ToString() == "" ? "" : "<span style='color:red;'>(Scheme)</span>"%>
                                </td>
                                <td style="width: 5%; font-size: 12px">
                                ...
                                <td style="width: 5%; font-size: 12px">
                                    <asp:Label ID="lblDiscount" runat="server" Text='<%#Eval("disc") %>'></asp:Label>
                                    (<%#Eval("dis_type") %>)
                                </td>
                                <td style="width: 5%; font-size: 12px">
            ...
            <tr>
                <td>
                    <table style="width: 100%; font-size: 12px">
                        <tr>
                            <td style="width: 50%">
                                Invocie Total (In Words): &nbsp;&nbsp;<asp:Label ID="lblwords" runat="server" Text="Label"></asp:Label>
                            </td>
                            <td style="width: 50%">
