...
public partial class user_CancelledBill : System.Web.UI.Page
{
    DataTable dt = null;
    ...
    {
        addgrid.Columns.Add("productid", typeof(int));
        addgrid.Columns.Add("productname", typeof(string));
        addgrid.Columns.Add("quantity", typeof(int));

        if (Session["userId"] == null)
            Response.Redirect("~/Default.aspx", false);
        else
        {
            strsessionid = Session["userId"].ToString();
    ...
    private void BindGrid()
    {
        try
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("select o.srno,o.appmstid,DATENAME(MONTH,o.doe) as monthname,o.status,SalesRep=case  o.salesrep when 'admin' then 'admin' else (select appmstfname from AppMst where AppMstRegNo=o.SalesRep) end,o.grossamt,a.appmstregno as regno,a.appmstfname as fname,o.NoOFProduct,o.Amount as amt,ToAddress as adrs,o.TaxRs as tax,o.DelCharge,o.Discount,o.netAmt,Detail as dtl, " +
                "CONVERT(varchar,Doe,103) AS doe from BillMst o inner join appmst a on a.appmstid=o.appmstid and a.appmstregno='"+strsessionid+"' and o.status=0 " +
    ...
    private void BindGrid1()
    {
        try
        {
            ...
            if (diff > 30)
            {
                utility.MessageBox(this, "Maximum 30 days allowed!");
                GridView1.DataSource = null;
                GridView1.DataBind();
                return;
            }
