<%@ Page Title="" Language="C#" MasterPageFile="user.master" AutoEventWireup="true" CodeFile="LoyaltyCoupon.aspx.cs" Inherits="User_LoyaltyCoupon" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    
    <h4 class="fs-20 font-w600  me-auto float-left mb-0">Lucky Draw </h4>
    ...
    <script type="text/javascript">
        ...
        function BindTable() {
            ...
            $.ajax({
                ...
                data: '{min: "' + min + '", max: "' + max + '", Coupon: "' + Coupon
                    + '", Status: "' + Status + '"}',
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        json.push([i + 1,
                           ...
                           data.d[i].Doe,
                           Stats,
                            data.d[i].WinningItem,
                            data.d[i].Remark,
                            data.d[i].DispatchedDate,
                            data.d[i].DispatchRemark,
