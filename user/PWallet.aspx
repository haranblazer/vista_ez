...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      <h4 class="fs-20 font-w600  me-auto float-left mb-0">Payout Wallet Passbook</h4>
     <div class="row">
  ...
  <hr />
    ...
    <div class="table-responsive">
        ...
        <%--  <asp:GridView ID="dglst" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            CssClass="table table-striped table-hover" Width="100%" OnPageIndexChanging="dglst_PageIndexChanging" HeaderStyle-BackColor="#fe6a00" HeaderStyle-ForeColor="#ffffff" PageSize="50">
            <Columns>
    ...
    <script type="text/javascript">
        var pageUrl = '<%=ResolveUrl("PWallet.aspx")%>';
        $JDT(function () {
            BindTable(); 
        });
