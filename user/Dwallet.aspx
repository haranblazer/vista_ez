...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h4 class="fs-20 font-w600  me-auto float-left mb-0">Company Wallet Passbook</h4>
   ...
   <hr />
    ...
    <div class="table-responsive">
       ...
       <%-- <asp:GridView ID="dglst" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            CssClass="table table-striped table-hover " Width="100%" HeaderStyle-BackColor="#fe6a00" HeaderStyle-ForeColor="#ffffff" OnPageIndexChanging="dglst_PageIndexChanging" PageSize="50" Style="margin-bottom: 0px;">
            <Columns>
   ...
   <%--<link href="datepick/jquery.datepick.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("Dwallet.aspx")%>';
        $JDT(function () {
            //$.noConflict(true);
            BindTable();
